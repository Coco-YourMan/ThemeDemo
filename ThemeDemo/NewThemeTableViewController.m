...
- (void)initData{
    ...
    [_dataArray addObject:@{@"tag" : @"red" , @"title" : @"红色" , @"color" : KUColorRGB(194, 43, 79)}];
    
    [_dataArray addObject:@{@"tag" : @"blue" , @"title" : @"蓝色" , @"color" : KUColorRGB(93, 178, 212)}];
    
    [_dataArray addObject:@{@"tag" : @"green" , @"title" : @"绿色" , @"color" : KUColorRGB(136, 190, 106)}];
    
    [_dataArray addObject:@{@"tag" : @"gray" , @"title" : @"紫色" , @"color" : KUColorRGB(147, 114, 176)}];
...
- (void)configTheme{
    ...
    self.navigationItem.leftBarButtonItem.KU_theme
    ...
    self.tableView.KU_theme.KUThemeChangingBlock(^(NSString *tag, UITableView *item) {
...
- (void)downloadThemeWithTag:(NSString *)tag CompleteBlock:(void (^)())completeBlock{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.0f * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [KUTheme addThemeConfigWithJson:redJson Tag:tag ResourcesPath:themePath];
...
- (void)removeThemeWithTag:(NSString *)tag{
    ...
    [KUTheme removeThemeConfigWithTag:tag];
